...
relation* rel_inter_body87_16_7 = new relation(1, false, 16, 275, "rel_inter_body87_16_7", "../data/4-4-256/inter-body87_16_7", FULL);
relation* rel_Lam_4_1_2_3_4 = new relation(4, true, 4, 257, "rel_Lam_4_1_2_3_4", "../data/4-4-256/Lam_4_1_2_3_4", FULL);
relation* rel_App_4_1_2_3_4 = new relation(4, true, 4, 268, "rel_App_4_1_2_3_4", "../data/4-4-256/App_4_1_2_3_4", FULL);
relation* rel_Step_15_15_14_13_12 = new relation(4, false, 15, 271, "rel_Step_15_15_14_13_12", "../data/4-4-256/Step_15_15_14_13_12", FULL);
relation* rel_Time_4_ = new relation(0, false, 4, 272, "rel_Time_4_", "../data/4-4-256/Time_4_", FULL);
relation* rel_inter_body87_16_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15_16 = new relation(16, true, 16, 275, "rel_inter_body87_16_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15_16", "../data/4-4-256/inter-body87_16_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15_16", FULL);
relation* rel_inter_body69_4_1_2_3_4 = new relation(4, true, 4, 263, "rel_inter_body69_4_1_2_3_4", "../data/4-4-256/inter-body69_4_1_2_3_4", FULL);
relation* rel_Lam_4_ = new relation(0, false, 4, 257, "rel_Lam_4_", "../data/4-4-256/Lam_4_", FULL);
relation* rel_Prog_1_ = new relation(0, false, 1, 256, "rel_Prog_1_", "../data/4-4-256/Prog_1_", FULL);
relation* rel_inter_body67_5_1_2_3_4_5 = new relation(5, true, 5, 258, "rel_inter_body67_5_1_2_3_4_5", "../data/4-4-256/inter-body67_5_1_2_3_4_5", FULL);
relation* rel_inter_body79_12_1_2_3_4_5_6_7_8_9_10_11_12 = new relation(12, true, 12, 274, "rel_inter_body79_12_1_2_3_4_5_6_7_8_9_10_11_12", "../data/4-4-256/inter-body79_12_1_2_3_4_5_6_7_8_9_10_11_12", FULL);
relation* rel_ReachesCfg_5_5_4_3_2 = new relation(4, false, 5, 265, "rel_ReachesCfg_5_5_4_3_2", "../data/4-4-256/ReachesCfg_5_5_4_3_2", FULL);
relation* rel_AEval_10_1_2_3_4_5_6_7_8_9_10 = new relation(10, true, 10, 273, "rel_AEval_10_1_2_3_4_5_6_7_8_9_10", "../data/4-4-256/AEval_10_1_2_3_4_5_6_7_8_9_10", FULL);
relation* rel_AEval_10_5_4_3_2 = new relation(4, false, 10, 273, "rel_AEval_10_5_4_3_2", "../data/4-4-256/AEval_10_5_4_3_2", FULL);
relation* rel_inter_body67_5_4_2 = new relation(2, false, 5, 258, "rel_inter_body67_5_4_2", "../data/4-4-256/inter-body67_5_4_2", FULL);
relation* rel_Step_15_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15 = new relation(15, true, 15, 271, "rel_Step_15_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15", "../data/4-4-256/Step_15_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15", FULL);
relation* rel_Store_10_1_2_3_4_5_6_7_8_9_10 = new relation(10, true, 10, 269, "rel_Store_10_1_2_3_4_5_6_7_8_9_10", "../data/4-4-256/Store_10_1_2_3_4_5_6_7_8_9_10", FULL);
relation* rel_inter_body80_19_15_14_13_7_5_3 = new relation(6, false, 19, 264, "rel_inter_body80_19_15_14_13_7_5_3", "../data/4-4-256/inter-body80_19_15_14_13_7_5_3", FULL);
relation* rel_Store_10_1 = new relation(1, false, 10, 269, "rel_Store_10_1", "../data/4-4-256/Store_10_1", FULL);
relation* rel_inter_body82_11_3_1 = new relation(2, false, 11, 270, "rel_inter_body82_11_3_1", "../data/4-4-256/inter-body82_11_3_1", FULL);
relation* rel_Var_2_ = new relation(0, false, 2, 262, "rel_Var_2_", "../data/4-4-256/Var_2_", FULL);
relation* rel_inter_body63_11_10_3 = new relation(2, false, 11, 267, "rel_inter_body63_11_10_3", "../data/4-4-256/inter-body63_11_10_3", FULL);
relation* rel_Time_4_1_2_3_4 = new relation(4, true, 4, 272, "rel_Time_4_1_2_3_4", "../data/4-4-256/Time_4_1_2_3_4", FULL);
relation* rel_inter_body79_12_12_9_7_5_4_3 = new relation(6, false, 12, 274, "rel_inter_body79_12_12_9_7_5_4_3", "../data/4-4-256/inter-body79_12_12_9_7_5_4_3", FULL);
relation* rel_inter_body82_11_1_2_3_4_5_6_7_8_9_10_11 = new relation(11, true, 11, 270, "rel_inter_body82_11_1_2_3_4_5_6_7_8_9_10_11", "../data/4-4-256/inter-body82_11_1_2_3_4_5_6_7_8_9_10_11", FULL);
relation* rel_inter_body69_4_3_2 = new relation(2, false, 4, 263, "rel_inter_body69_4_3_2", "../data/4-4-256/inter-body69_4_3_2", FULL);
relation* rel_Lam_4_1 = new relation(1, false, 4, 257, "rel_Lam_4_1", "../data/4-4-256/Lam_4_1", FULL);
relation* rel_App_4_3_1 = new relation(2, false, 4, 268, "rel_App_4_3_1", "../data/4-4-256/App_4_3_1", FULL);
relation* rel_Prog_1_1 = new relation(1, true, 1, 256, "rel_Prog_1_1", "../data/4-4-256/Prog_1_1", FULL);
relation* rel_inter_head76_23_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23 = new relation(23, true, 23, 261, "rel_inter_head76_23_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23", "../data/4-4-256/inter-head76_23_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23", FULL);
relation* rel_Var_2_2 = new relation(1, false, 2, 262, "rel_Var_2_2", "../data/4-4-256/Var_2_2", FULL);
relation* rel_ReachesClo_5_1_2_3_4_5 = new relation(5, true, 5, 259, "rel_ReachesClo_5_1_2_3_4_5", "../data/4-4-256/ReachesClo_5_1_2_3_4_5", FULL);
relation* rel_inter_body63_11_1_2_3_4_5_6_7_8_9_10_11 = new relation(11, true, 11, 267, "rel_inter_body63_11_1_2_3_4_5_6_7_8_9_10_11", "../data/4-4-256/inter-body63_11_1_2_3_4_5_6_7_8_9_10_11", FULL);
relation* rel_ReachesCfg_5_1_2_3_4_5 = new relation(5, true, 5, 265, "rel_ReachesCfg_5_1_2_3_4_5", "../data/4-4-256/ReachesCfg_5_1_2_3_4_5", FULL);
relation* rel_Var_2_1_2 = new relation(2, true, 2, 262, "rel_Var_2_1_2", "../data/4-4-256/Var_2_1_2", FULL);
relation* rel_inter_body64_2_2_1 = new relation(2, true, 2, 260, "rel_inter_body64_2_2_1", "../data/4-4-256/inter-body64_2_2_1", FULL);
relation* rel_inter_body80_19_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15_16_17_18_19 = new relation(19, true, 19, 264, "rel_inter_body80_19_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15_16_17_18_19", "../data/4-4-256/inter-body80_19_1_2_3_4_5_6_7_8_9_10_11_12_13_14_15_16_17_18_19", FULL);
